...
pub fn window_event(
    ...
    match event {
        ...
        WindowEvent::PinchGesture { delta, phase, .. } => match phase {
            winit::event::TouchPhase::Moved if delta.is_finite() && delta != 0.0 => {
                Some(Event::Mouse(mouse::Event::WheelZoomed { delta: delta as f32 }))
            }
            _ => None,
        },
